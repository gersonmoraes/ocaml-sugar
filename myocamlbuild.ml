(* OASIS_START *)
(* DO NOT EDIT (digest: d9f89f81bb29606b420fff3932d997ed) *)
...
let package_default =
  {
     ...
     includes =
       [
          ("lib/lwt", ["lib/sugar"]);
          ("lib/async", ["lib/sugar"]);
          ("examples/semicolon", ["lib/lwt"; "lib/sugar"]);
          ("examples/lwt", ["lib/lwt"; "lib/sugar"]);
          ("examples/basic", ["lib/sugar"]);
          ("examples/async", ["lib/async"; "lib/sugar"])
       ]
  }
  ;;
