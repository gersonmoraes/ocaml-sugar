...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7a3b37a0f04e62cffcdf0dc398d33e04) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "A library to bring sugar syntatic to your error handling layer.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build everything possible";
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Sugar_generic";
                           "Sugar_machine";
                           "Sugar_monadic_with_natural";
                           "Sugar_machine_with_shared_errors"
                        ];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "sugar";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Sugar_async"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "sugar";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "sugar"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "free_basic.ml"});
               Executable
                 ({
                     cs_name = "free_error_aware";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "free_error_aware.ml"
                   });
               Executable
                 ({
                     cs_name = "free_error_aware_combined";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "free_error_aware_combined.ml"
                   });
               Executable
                 ({
                     cs_name = "example_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "example_async.ml"});
               Executable
                 ({
                     cs_name = "example_semicolon";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "example_semicolon.ml"
                   });
               Doc
                 ({
                     cs_name = "sugar";
                  ...
                  },
                   {
                      ...
                      doc_title = "Sugar reference";
                      doc_authors = [];
                      doc_abstract =
                        Some
                          "Sugar is a small monadic library to simplify error handling layers.";
                      doc_format = OtherDoc;
                      doc_data_files = [];
                      doc_build_tools =
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\199\156\147y\209\222\142r\204.\187\022=\156/|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
