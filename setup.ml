...
(* OASIS_START *)
(* DO NOT EDIT (digest: c1f379bfb15de4c6ab14ced26dad043a) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Sugar"];
                      lib_pack = false;
                      lib_internal_modules = ["Sugar_option"; "Sugar_result"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "example_monadic.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\162\182`!\b$\135\011h$gS\236\218\230\022";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
